...
@log_controller.route('/admin/logs')
@login_required
def logs():
...
@log_controller.route('/admin/logs/<int:log_id>')
@login_required
def log_details(log_id):
    ...
    try:
        ...
        if not log_details:
            ...
            return redirect(url_for('log_controller.logs'))
...
@log_controller.route('/admin/logs/cleanup', methods=['POST'])
@login_required
def cleanup_logs():
    """Czyści stare logi"""
    try:
...
@log_controller.route('/admin/logs/export')
@login_required
def export_logs():
...
@log_controller.route('/admin/logs/stats/refresh')
@login_required
def refresh_stats():
